...
| `skillsRefresh`            | `"every-turn"`                   | When skill sources are re-listed: `"every-turn"`, `"on-start"` (load once), or `{ intervalMs }`. Continuations of an in-flight turn never refresh                                                                                                                                                                                                                                                                                                                                                                           |
