...
A recovery attempt that is interrupted again and schedules the next attempt no longer marks the incident `failed` or finishes the durable submission as `aborted`; the scheduled attempt owns the outcome.
