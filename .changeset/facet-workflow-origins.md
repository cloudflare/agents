...
- Make facet workflow broadcasts (`broadcastToClients()`) await the parent hop so a facet that hibernates immediately after the workflow RPC no longer drops the message.
