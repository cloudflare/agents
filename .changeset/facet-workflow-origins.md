...
- Make facet workflow broadcasts (`broadcastToClients()`) await the parent hop so completion, ordering, and failures are correctly observed by the workflow caller.
