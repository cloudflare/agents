/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4f1c7698c7e1908d8efc30937933e047)
// Runtime types generated with workerd@1.20250906.0 2025-03-14 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    SERVER_TEST_PK: string;
    CLIENT_TEST_PK: string;
    PAY_MCP: DurableObjectNamespace<import("./src/index").PayMCP>;
