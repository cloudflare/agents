...
| [`harnesses/pi`](./harnesses/pi)                         | This PR   | Experimental: pi `AgentHarness` as a Lifecycle capability, running pi's own extensions, slash commands and file/bash tools over a Shell Workspace |
