...
| `browser-interaction.md`                 | design doc | Internal browser interaction layer — provider-agnostic contract and verb-level provider seam, named session core, `BrowserSessions` lifecycle capability (eval-gated experiment) |
