...
| `pi-extensions.md`                       | design doc | Pi extension surface on the harness example — vendored extension runtime, hook and event mapping, Workspace ExecutionEnv, fold-into-package checklist                           |
