...
| Durable Object lifecycle composition                                     | ✅ `lifecycle-export.test-d.ts` |                                             —                                             |                                           ✅ `agents/src/lifecycle-tests/` (direct DO composition, phases, identity, routing, hibernating WebSockets)                                           |                                                                                             —                                                                                             |                                   —                                    |                        —                         |            —             |
| Cold native RPC initialization                                           |                —                |                                             —                                             | ✅ `agents/src/tests/native-rpc-initialization.test.ts`, `think/src/tests/cold-rpc-initialization.test.ts` (startup before inherited/subclass/`_cf_*` RPC, legacy name migration, cold destroy) |                                                                                             —                                                                                             |                                   —                                    |                        —                         |            —             |
