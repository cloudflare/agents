...
| Durable Object lifecycle composition                                     | ✅ `lifecycle-export.test-d.ts` |                                             —                                             | ✅ `agents/src/tests/lifecycle/` (composition, host context, phases, identity, routing, hibernating WebSockets) |                                                                                             —                                                                                             |                                   —                                    |                        —                         |            —             |
...
| Messaging Channels (`agents/channels`)                                   |                —                |                      ✅ `agents/src/channels/__tests__/` (152 tests)                      |                                      ✅ `voice/src/tests/channels.test.ts`                                      |                                                                                             —                                                                                             |                                   —                                    |                        —                         |            —             |
| Think channels (policy re-apply across recovery)                         |               ✅                |                                            ✅                                             |                                          ✅ `channel-recovery.test.ts`                                          |                                                                                             —                                                                                             |                                   —                                    |                        —                         |            —             |
