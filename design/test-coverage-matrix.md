...
| Durable Object lifecycle composition                                     | ✅ `lifecycle-export.test-d.ts` |                                             —                                             |   ✅ `agents/src/tests/lifecycle/` (composition, context, phases, identity, routing, hibernating WebSockets)    |                                                                                             —                                                                                             |                                   —                                    |                        —                         |            —             |
