...
| Durable Object lifecycle composition                                     | ✅ `lifecycle-export.test-d.ts` |                                                                       —                                                                        |      ✅ `agents/src/tests/lifecycle/` (composition, context, phases, shared alarm contributions, identity, routing, hibernating WebSockets)      |                                                                                             —                                                                                             |                                   —                                    |                        —                         |            —             |
| Scheduler Lifecycle primitive and Agent alarm arbitration                | ✅ `schedules-export.test-d.ts` | ✅ `schedule-timing.test.ts` (pure timing), `tests/lifecycle/scheduler-capability.test.ts` (capability alone on a real harness Durable Object) | ✅ `tests/lifecycle/`, `schedule.test.ts`, `alarms.test.ts`, `migration.test.ts`, `keep-alive.test.ts`, `run-fiber.test.ts`, `sub-agent.test.ts` |                                                                                             —                                                                                             |                 ⚠️ indirect through fiber/recovery e2e                 |                        —                         |            —             |
| `hono-agents` middleware routing                                         |                —                |                                                                       —                                                                        |                                                           ✅ `hono-agents/src/tests/`                                                            |                                                                                             —                                                                                             |                                   —                                    |                        —                         |            —             |
...
| Actions / HITL (durable pause × recovery)                                |               ✅                |                                                                       ✅                                                                       |                                                        ✅ `action-pause-recovery.test.ts`                                                        |                                                                                             —                                                                                             |                        ✅ think `action-*` e2e                         |                        —                         |            —             |
