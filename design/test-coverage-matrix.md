...
| Durable Object lifecycle composition                                     | ✅ `lifecycle-export.test-d.ts` |                                             —                                             |   ✅ `agents/src/tests/lifecycle/` (direct DO composition, phases, identity, routing, hibernating WebSockets)   |                                                                                             —                                                                                             |                                   —                                    |                        —                         |            —             |
