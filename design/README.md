...
| [rfc-harness-capability.md](./rfc-harness-capability.md)                           | RFC: `agents/harness` — one developer API for every harness, runtime port, remote Claude Code over capnweb |
