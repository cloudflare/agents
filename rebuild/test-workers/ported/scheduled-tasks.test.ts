 ...
 * - packages/think/src/tests/scheduled-tasks.test.ts
 * - last original change: unknown
 * - port date: 2026-07-15
 * Modifications:
 * - Re-pointed `partyserver` import to `./compat.js`.
 * - Re-pointed original fixture/type imports to `./fixtures/index.js` and
 *   `./compat.js`.
...
import type { ThinkScheduledTasksTestAgent } from "./fixtures/index.js";
import type { ThinkSubmissionInspection } from "./compat.js";
