 ...
 * - packages/think/src/tests/run-turn.test.ts
 * - last original change: unknown in this worktree
 * - port date: 2026-07-15
 * Modifications:
 * - Re-pointed `partyserver`, `agents/observability`, and Think type imports
 *   to the ported compat shim / shared fixture index.
 */
// @ts-nocheck
...
import type { SubmitMessagesResult, TurnResult } from "./compat.js";
import type { ThinkProgrammaticTestAgent } from "./fixtures/index.js";
