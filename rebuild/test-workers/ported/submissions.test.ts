// @ts-nocheck
// Ported from ../packages/think/src/tests/submissions.test.ts
// Port date: 2026-07-15
// Modifications: compat imports, rebuilt fixture module, distinct submissions fixture DO binding.
import { env } from "cloudflare:workers";
import { getServerByName } from "./compat.js";
import { describe, expect, it, vi } from "vitest";
vi.setConfig({ testTimeout: 10000 });
import type { UIMessage } from "ai";
import type { ThinkSubmissionsTestAgent } from "./fixtures/submissions-agents.js";
import type {
...
async function freshAgent(
  ...
  return getServerByName(
    env.ThinkSubmissionsTestAgent as unknown as DurableObjectNamespace<ThinkSubmissionsTestAgent>,
    name
