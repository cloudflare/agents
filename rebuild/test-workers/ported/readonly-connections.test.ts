 ...
 * - Re-authored fixture against rebuild `Think` + hostAgent, preserving the
 *   original assertions that expose missing connection-level readonly wiring.
 */
// @ts-nocheck
...
describe("Readonly Connections (ported)", () => {
