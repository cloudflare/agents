 ...
 * - packages/think/src/e2e-tests/task-amplification.test.ts
 * - last original change: ab6dd95b
 * - port date: 2026-07-15
 * Modifications:
 * - Removed the original side-effect harden-net import; kept the original
 *   in-file process/WebSocket helpers for this long-running recovery port.
 * - Changed port to 18809 for this rebuild e2e file.
 */
/**
