// Vendored test from packages/agents/src/tests/mcp/normalize-server-id.test.ts @ 762998da, ISSUE-003 (phase 3).
import { describe, it, expect } from "vitest";
import { normalizeServerId, MCP_SERVER_ID_MAX_LENGTH } from "../vendor/mcp/client.js";
