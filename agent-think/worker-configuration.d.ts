/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 64e24a9fdf4650a25bc9dfcc4a61bce0)
// Runtime types generated with workerd@1.20260625.1 2026-06-11 enable_abortsignal_rpc,nodejs_compat
interface __BaseEnv_Env {
  ...
  ThinkAgent: DurableObjectNamespace<import("./src/index").ThinkAgent>;
  WorkspaceAgent: DurableObjectNamespace<import("./src/index").WorkspaceAgent>;
  Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
  WarmPool: DurableObjectNamespace<import("./src/index").WarmPool>;
  CommandCenter: DurableObjectNamespace<
    import("./src/index").CommandCenterAgent
  >;
  GITHUB_AUTH: Service /* entrypoint AgentThinkTokenBroker from gh-app */;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "PUBLIC_BASE_URL">
  > {}
}
