...
export { HeartbeatSilentObject } from "./capabilities/heartbeat.ts";
import type { HeartbeatSilentObject } from "./capabilities/heartbeat.ts";
export {
...
export type Env = {
  ...
  HeartbeatSilentObject: DurableObjectNamespace<HeartbeatSilentObject>;
