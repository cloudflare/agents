...
| `agents/channels`             | `src/channels/index.ts`          | Stateless messaging adapters, routing, surfaces, and identity links          |
| `agents/channels/slack`       | `src/channels/adapters/slack.ts` | Slack Channel adapter                                                        |
| `agents/channels/ai-sdk`      | `src/channels/ai-sdk.ts`         | AI SDK adapter for Channel delivery                                          |
| `agents/channels/tanstack-ai` | `src/channels/tanstack-ai.ts`    | TanStack AI adapter for Channel delivery                                     |
...
src/
  ...
  channels/             # Stateless messaging Channels, Router, and adapters
...
- **Channels is stateless** — `ChannelRouter` authenticates and normalizes inbound provider events, selects application routes, and resolves outbound surfaces. Applications own storage, deduplication, retries, and durable handoff.
