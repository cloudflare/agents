...
import { isTypeScriptFile } from "./source-file-kinds";
// The transformation itself lives in ./transform so the published
// `@cloudflare/worker-bundler/transform` subpath never touches the resolver.
